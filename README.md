...
- **Dev Server URL**: `http://127.0.0.1:5215`
- **Preview URL**: `https://api.chitterchat.co.uk/chipify/projects/ed221562-53c1-48e7-8013-a85d414417bf/preview`
- **Port**: `5215`
...
4. The dev server is accessible at `http://127.0.0.1:5215`
5. Preview the application using the preview URL: `https://api.chitterchat.co.uk/chipify/projects/ed221562-53c1-48e7-8013-a85d414417bf/preview`
